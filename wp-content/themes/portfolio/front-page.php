                        ...
                        <li class="container">
                            <div class="container__content">
                                <div class="info">
                                    ...
                                    <p class="description"><?php the_field("intro_description") ?></p>
                                    <?php
                                    ...
                                    <div class="actions">
                                        <ul class="links">
                                            <li class="link"><a href="<?php the_field("github_link") ?>" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-github">
                                                        <title>GitHub</title>
                                        ...
                                        <button class="details" onclick="openProjectModal(<?php echo the_ID() ?>)">Details <span>&rarr;</span></button>
                                    </div>
                                </div>
                            </div>
